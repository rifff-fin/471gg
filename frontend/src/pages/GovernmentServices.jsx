...
const GovernmentServices = () => {
  const services = [
...

    {
      ...
      description: "Apply for and manage your electronic passport services.",
      icon: <FaPassport />,
...

    {
      ...
      description: "Access BRTA driving license forms and related services.",
      icon: <FaCar />,
  ...
  return (
    <div className="page-container">
      ...
      <p>Access official government service portals from one place.</p>
