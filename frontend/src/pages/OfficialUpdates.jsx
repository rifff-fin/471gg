...
const OfficialUpdates = () => {
  ...
  const canPublish = ["mayor", "councillor"].includes(user?.role);
  ...
  return (
    <main className="site-shell official-page official-newsroom">
      ...
      {!canPublish && (
        <aside className="official-reader-note">
          <FaShieldHeart />
          <div>
            <strong>Verified community updates</strong>
            <p>
              Everyone can read official updates. Only verified mayor and
              councillor accounts can publish.
            </p>
          </div>
        </aside>
      )}
